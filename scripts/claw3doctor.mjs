  ...
  checks.push(
    runtimeContext.gatewayUrl
      ...
      : checkFail(
          ...
          ["Set the gateway URL in Escritorio Builderfy connect/settings before retrying."],
        ),
  );
  ...
  checks.push(
    runtimeContext.tokenConfigured
      ...
      : checkWarn(
          ...
          [
            "If this backend requires token auth, set the upstream token in Escritorio Builderfy settings or openclaw.json.",
          ],
        ),
  );
    ...
    checks.push(
      requestedProfile
        ...
        : checkFail(
            ...
            [
              "Run `node scripts/escritorio-builderfyoctor.mjs --all-profiles` to see the configured profile list.",
            ],
          ),
    );
